...
int Test0()
{
    ...
    std::vector<Vcw::VirtualCamera> virtualCameras;
    virtualCameras.push_back(Vcw::VirtualCamera(cameraResolution, cameraPrincipalPoint, cameraFocalLength, cameraDistortionCoefficients));
    virtualCameras.push_back(Vcw::VirtualCamera(cameraResolution, cameraPrincipalPoint, cameraFocalLength, cameraDistortionCoefficients));
    virtualCameras.push_back(Vcw::VirtualCamera(cameraResolution, cameraPrincipalPoint, cameraFocalLength, cameraDistortionCoefficients));
    virtualCameras.push_back(Vcw::VirtualCamera(cameraResolution, cameraPrincipalPoint, cameraFocalLength, cameraDistortionCoefficients));

    Vcw::VirtualWorld virtualWorld(virtualCameras);
    ...
    for(int k=0; k< virtualWorld.VirtualCameras.size();k++)
    {
        std::cout << virtualWorld.VirtualCameras[k].ID << "\n";
    }
